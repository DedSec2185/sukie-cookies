...
export default function TastingNotes() {
  ...
  const flavors = [
    ...
    },
    {
      ...
      notes: ["Sicilian Pistachios", "In-house Gianduja", "European Butter", "Sea Salt"],
      sensory: {
        richness: 92,
        crunch: 76,
        gooeyness: 96,
      ...
      story: "Slow-roasted pistachios ground into in-house velvety gianduja folded into melted Belgian white chocolate. Break the crust to release an emerald molten lava center.",
      tag: "Chef's Pride",
      weight: "170g (6oz)",
      price: 349,
      itemData: {
    ...
    },
    {
      ...
      notes: ["54.5% Couverture Dark (Center)", "Milk Chunks", "Dark Cocoa Shell", "Ganache Lava"],
      sensory: {
        richness: 98,
        crunch: 68,
        gooeyness: 100,
      ...
      story: "For the cocoa purist. A dark Dutch cocoa crumb packed with milk & white chunks, hiding an intense 54.5% couverture dark molten center.",
      tag: "Bestseller",
      weight: "170g (6oz)",
      price: 299,
      itemData: {
    ...
    },
    {
      ...
      notes: ["Ruby Callebaut 33%", "Cheesecake Core", "Wild Berries", "Pink Shell"],
      sensory: {
        richness: 88,
        crunch: 72,
        gooeyness: 90,
      ...
      story: "Crafted with authentic Belgian Ruby Callebaut 33% paired with our signature molten cheesecake core. Naturally pink without colorants, yielding delicate berry-tart notes.",
      tag: "Rare Ruby",
      weight: "170g (6oz)",
      price: 379,
      itemData: {
